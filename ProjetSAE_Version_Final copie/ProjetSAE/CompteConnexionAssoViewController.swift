//
//  CompteConnexionAssoViewController.swift
//  ProjetSAE
//
...
class CompteConnexionAssoViewController: UIViewController {
    ...
    // MARK: - Actions
    @IBAction func connexionTapped(_ sender: UIButton) {
        guard
        ...
        AuthService.login(email: mail, password: motDePasse, expectedType: .association) { [weak self] result in
            DispatchQueue.main.async {
                ...
                case .success(let data):
                    ...
                    self?.performSegue(withIdentifier: "goToMonCompteAsso", sender: self)
